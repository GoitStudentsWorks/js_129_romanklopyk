import{a as B,S as x,b as W,c as q,d as O,N as P,P as I,i as C,A as _}from"./assets/vendor-BPsa392G.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(o){if(o.ep)return;o.ep=!0;const n=s(o);fetch(o.href,n)}})();B.defaults.baseURL="https://deserts-store.b.goit.study/api";async function A(e,t={}){try{return(await B(e,t)).data}catch(s){console.log(s)}}async function F(e){try{return(await B.post("/orders",e)).data}catch(t){console.log(t)}}async function j(e){const t=new x({lines:12,length:6,width:4,radius:8,color:"#e39622"}),s=W.create(`
